...
while [ $counter -lt $timeout ]; do
    if docker compose --env-file .env.docker ps | grep -q "eduverse-postgres.*healthy"; then
...
if docker compose --env-file .env.docker ps | grep -q "eduverse-redis.*healthy"; then
...
echo ""
echo -e "${GREEN}================================================${NC}"
echo -e "${GREEN}Starting Eduverse Dev Servers...${NC}"
echo -e "${GREEN}================================================${NC}"
echo ""

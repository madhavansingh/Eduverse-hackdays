      ...
      >
        ...
        <div className="h-16 flex-shrink-0 flex items-center justify-between px-4 border-b border-border">
          <Link to="/" className="flex items-center gap-2">
            <img src="/logos/eduverse-logo.png" alt="Eduverse" className="w-8 h-8 object-contain" />
        ...
        <header className="h-16 bg-card border-b border-border sticky top-0 z-30">
          <div className="h-full px-4 flex items-center justify-between">
            ...
            <div className="relative ml-2">
              ...
              >
                <div className="relative w-8 h-8 rounded-full bg-green-500/10 flex items-center justify-center overflow-hidden">
                  <span className="text-sm font-medium text-green-600" aria-hidden="true">

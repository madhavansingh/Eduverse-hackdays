  ...
  return (
    <div className="relative">
      ...
      >
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold bg-gradient-to-r from-blue-600 via-cyan-500 to-purple-600 bg-clip-text text-transparent">Eduverse</span>
              </div>
            </div>
        ...
        {/* Content */}
        <div className="p-6 sm:p-8 min-h-[410px] sm:min-h-[440px] relative flex flex-col justify-between">
          {/* Confetti */}
          {showConfetti && (
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center pt-20 pb-16 lg:pt-24 lg:pb-20 overflow-hidden bg-gradient-to-b from-green-50/60 via-emerald-50/35 to-background dark:from-green-950/20 dark:via-emerald-950/10 dark:to-background">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute -top-24 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-green-300/40 via-emerald-300/30 to-teal-200/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.15, 1, 1.15],
          ...
          className="absolute top-1/3 -right-20 w-[650px] h-[650px] bg-gradient-to-br from-emerald-400/30 via-green-300/35 to-teal-300/25 rounded-full blur-3xl"
        />
      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-14 xl:px-20 max-w-7xl">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center py-4 lg:py-8">
          {/* Left Content */}
          <motion.div
            variants={containerVariants}
            initial="hidden"
            animate="visible"
            className="lg:col-span-6 flex flex-col justify-center max-w-2xl"
          >
            {/* Headline */}
            <motion.h1
              variants={itemVariants}
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.12] mb-6"
            >
              <span>Study Smarter.</span>{' '}
              <span className="block mt-2 pb-1.5 bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 bg-clip-text text-transparent">
            ...
            <motion.p
              variants={itemVariants}
              className="text-slate-600 text-lg sm:text-xl leading-relaxed mb-9 max-w-[580px] font-normal"
            >
              Turn your PDFs, lecture notes, handwritten pages, and YouTube videos into organized flashcards, step-by-step explanations, and exam practice. Built for students who value their time.
            </motion.p>
            ...
            >
              <Link
                to={ctaLink}
                className="group inline-flex items-center justify-center gap-2 h-12 px-7 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-base shadow-sm hover:shadow-md transition-all duration-200"
              >
              ...
              <a
                href="#how-it-works"
                className="group inline-flex items-center justify-center gap-2 h-12 px-6 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-medium text-base border border-slate-200/80 hover:border-slate-300 shadow-2xs hover:shadow-xs transition-all duration-200"
              >
                <Play className="w-4 h-4 text-slate-700 fill-slate-700 group-hover:text-emerald-600 group-hover:fill-emerald-600 transition-colors" />
            ...
            <motion.div
              variants={itemVariants}
              className="pt-6 border-t border-slate-200/70"
            >
              <div className="flex flex-wrap items-center gap-2.5 text-xs sm:text-sm font-medium text-slate-700">
                {trustBadges.map((badge) => (
                  <motion.div
                    key={badge}
                    whileHover={{ y: -2 }}
                    className="flex items-center gap-2 bg-white/90 backdrop-blur-md px-3.5 py-2 rounded-xl border border-slate-200/80 shadow-2xs hover:border-emerald-500/40 hover:shadow-xs transition-all cursor-default"
                  >
                    <CheckCircle2 className="w-4 h-4 text-emerald-600 flex-shrink-0" />
                    <span className="text-slate-800 font-semibold">{badge}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          {/* Right Content - Interactive Demo Illustration with Subtle Float */}
          <motion.div
            initial={{ opacity: 0, scale: 0.96, y: 20 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.2, ease: [0.22, 1, 0.36, 1] }}
            className="lg:col-span-6 relative w-full max-w-xl mx-auto lg:max-w-none"
          >
            <motion.div
              animate={{ y: [0, -5, 0] }}

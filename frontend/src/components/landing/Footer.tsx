...
const socialLinks = [
  { name: 'X (Twitter)', icon: Twitter, href: 'https://x.com/MadhavanEra', color: 'hover:text-sky-500' },
  { name: 'GitHub', icon: Github, href: 'https://github.com/madhavansingh', color: 'hover:text-foreground' },
  { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/madhavan-singh/', color: 'hover:text-blue-600' },
  { name: 'Email', icon: Mail, href: 'mailto:madhavansingh32@gmail.com', color: 'hover:text-green-500' },
];
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-2">
              <Link to="/" className="inline-flex items-center gap-2.5 mb-5 group">
                <img src="/logos/eduverse-logo.png" alt="Eduverse" className="w-10 h-10 object-contain transition-transform group-hover:scale-110" />

      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="relative w-14 h-14 shrink-0">
            <div className={`relative w-14 h-14 rounded-full ${levelInfo ? `bg-gradient-to-br ${levelInfo.gradient}` : 'bg-green-500/10'} flex items-center justify-center overflow-hidden ring-2 ring-background`}>

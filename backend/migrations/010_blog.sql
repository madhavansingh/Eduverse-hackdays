...
CREATE TABLE IF NOT EXISTS blog_posts (
    ...
    tags JSONB DEFAULT '[]',
    author_name VARCHAR(100) NOT NULL DEFAULT 'Eduverse Team',
    author_avatar TEXT,
...
The SM-2 algorithm, which powers Eduverse''s flashcard system, calculates the optimal time to review each card based on:
...
### Why Eduverse Makes It Easy

With Eduverse, you don''t need to track any of this manually. Our intelligent flashcard system automatically:
...
Create your first study set on Eduverse and let our spaced repetition system handle the rest. Your brain will thank you.

---

*Start studying smarter today with Eduverse''s built-in spaced repetition system.*',
 'study-tips',
...
('ai-powered-studying',
 ...
 'From generating flashcards to solving complex problems, AI tools are transforming education. Here''s how Eduverse puts AI to work for you.',
 '## How AI Is Revolutionizing the Way Students Study

Artificial intelligence is no longer a futuristic concept — it''s here, and it''s changing the way millions of students learn every day. At Eduverse, we''ve integrated AI deeply into the study experience to help you work smarter, not harder.

### AI-Powered Features in Eduverse

#### 1. Smart Flashcard Generation
Upload any document, paste text, or even take a photo of your textbook — Eduverse''s AI will automatically generate high-quality flashcards. No more spending hours manually creating cards.
...
*Experience the future of studying — try Eduverse''s AI features today.*',
 'ai-features',
...
Eduverse supports cloze cards natively with the `{{...}}` syntax.
...
The best part? Eduverse supports all of these techniques out of the box. Standard cards, cloze deletions, and image occlusion — all powered by spaced repetition.

---

*Create your first set of optimized flashcards on Eduverse today.*',
 'study-tips',
...
('live-quiz-classroom',
 ...
 'Turn boring review sessions into exciting competitions with Eduverse''s Live Quiz feature. Perfect for classrooms and study groups.',
 '## How to Use Live Quizzes to Make Studying Fun

Studying doesn''t have to be a solitary, boring activity. With Eduverse''s **Live Quiz** feature, you can turn any study set into a real-time competitive quiz — perfect for classrooms, study groups, or even remote learning sessions.
...
Any study set on Eduverse can be turned into a Live Quiz with one click. Try it with your next study group session!

---

*Make studying social — host your first Live Quiz on Eduverse.*',
 'features',
...
- Create a study set for each subject on Eduverse
...
- Use Eduverse''s study schedule feature to plan your review sessions
...
### The Eduverse Advantage

With features like spaced repetition, AI quiz generation, exam clones, and detailed analytics, Eduverse gives you everything you need to prepare effectively.

---

*Start your exam prep today — create a study set and set your exam date on Eduverse.*',
 'study-tips',
...
('handwriting-ocr-digital-notes',
 ...
 'Love writing by hand but hate losing your notes? Learn how Eduverse''s Handwriting OCR bridges the gap between analog and digital study.',
 '## From Handwritten to Digital: How OCR Transforms Your Notes
...
That''s where Eduverse''s **Handwriting OCR** comes in.

### What Is Handwriting OCR?

OCR (Optical Character Recognition) is technology that converts images of text into actual, editable digital text. Eduverse''s OCR is powered by advanced AI vision models that can read even messy handwriting.

### How to Use It

1. **Take a photo** of your handwritten notes
2. **Upload it** to Eduverse
...
*Try Eduverse''s Handwriting OCR — turn your notebook into a study powerhouse.*',
 'features',
...
('study-analytics-track-progress',
 ...
 'Data-driven studying isn''t just for overachievers. Learn how Eduverse''s analytics help you identify weaknesses and study more effectively.',
 '## Why Tracking Your Study Progress Changes Everything
...
*Start tracking your study progress — check your Eduverse analytics dashboard today.*',
 'productivity',
...
('teach-back-method',
 ...
 'Teaching is the most effective way to learn. Eduverse''s Teach Back mode lets you explain concepts to an AI tutor that asks clarifying questions.',
 '## The Teach Back Method: Learn by Teaching an AI
...
### How Eduverse''s Teach Back Works
...
*Try the Teach Back feature on Eduverse — your AI student is waiting.*',
 'study-tips',
...
('deep-research-essays',
 ...
 'Stop spending hours on manual research. Eduverse''s Deep Research generates comprehensive reports with sources, outlines, and key insights.',
 '## How to Write Better Essays with AI-Powered Deep Research

Writing a research paper or essay can be overwhelming. Finding reliable sources, organizing information, and synthesizing arguments takes hours — sometimes days. Eduverse''s **Deep Research** feature cuts that time dramatically.
...
*Try Deep Research on Eduverse — your personal research assistant.*',
 'ai-features',
...
('getting-started-eduverse',
 'Getting Started with Eduverse: A Complete Beginner''s Guide',
 'New to Eduverse? This complete guide walks you through creating your account, setting up your first study set, and making the most of every feature.',
 '## Getting Started with Eduverse: A Complete Beginner''s Guide

Welcome to Eduverse! Whether you''re a high school student, university learner, or lifelong educator, this guide will help you get up and running in minutes.

### Step 1: Create Your Account

Sign up at eduverse.com with your email or Google account. The free plan gives you access to core features including:
- Study set creation
...
2. **Trust the algorithm** — review cards when Eduverse tells you to
